...
void random1()
{
	...
	srand(time(NULL));        //to generate different numbers everytime If you pass in NULL, it just ignores it and merely returns a new time_t object that represents the current time.
